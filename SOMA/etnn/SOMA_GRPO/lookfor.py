...
def run_meta_grpo():
    ...
    for s_idx in range(40):
        ...
        p0 = mp.Process(target=worker_fast_proxy, args=(0, actions_np_main[0], 1, paths, tmp_target_csv, cfg.sup_source_paths, base_model_path, mae_ref, g_mean, g_std, results_map))
        p0.start()
        p0.join()
        if 0 in results_map:
