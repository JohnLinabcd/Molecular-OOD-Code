...
#     def __init__(self, csv_paths, cache_dir="./cache", label_name="lumo", stage="train", config=None, filter_smiles=None, calc_brics=True):
...
#         label_key = self.config.get('label_name', 'lumo')
